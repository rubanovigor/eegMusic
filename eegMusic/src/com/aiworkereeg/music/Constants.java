...
public final class Constants {
    ...
    public static final String ACTION_VIEW_IMAGE =
            "com.aiworkereeg.music.ACTION_VIEW_IMAGE";

    public static final String ACTION_ZOOM_IMAGE =
            "com.aiworkereeg.music.ACTION_ZOOM_IMAGE";
    
    // Defines a custom Intent action
    public static final String BROADCAST_ACTION = "com.aiworkereeg.music.BROADCAST";

    // Fragment tags
    public static final String PHOTO_FRAGMENT_TAG =
            "com.aiworkereeg.music.PHOTO_FRAGMENT_TAG";
    
    public static final String THUMBNAIL_FRAGMENT_TAG =
            "com.aiworkereeg.music.THUMBNAIL_FRAGMENT_TAG";
    ...
    public static final String EXTENDED_FULLSCREEN =
            "com.aiworkereeg.music.EXTENDED_FULLSCREEN";
